...
require_once 'PEAR/Image/Text.php';
...
class Text_CAPTCHA_Driver_Image extends Text_CAPTCHA
{
    ...
    function _createCAPTCHA()
    {
        ...
        $pp = new PEAR();
        if ($pp->isError($e = $this->_imt->init())) {
    ...
    function getCAPTCHAAsPNG()
    {
        ...
        $pp = new PEAR();
        if ($pp->isError($retval)) {
            return $pp->raiseError($retval->getMessage());
        }
    ...
    function getCAPTCHAAsGIF()
    {
        ...
        if (is_resource($this->_im)) {
            ...
            $this->_error = $pp->raiseError('Error creating CAPTCHA image (font missing?!)');
            return $this->_error;
        }
    }
