...
{{headerdown
		...
		<h2>Shipments</h2>
		?$mailboxes
		<table class="table"><tr><th>Mailbox</th><th>Shipments</th><th>Last shipment</th><th>Last error</th></tr>
		[$mailboxes]
		...
		<h1>Restrictions</h1>
		<table class="table"><tr><th>ID</th><th>From pattern</th><th>To pattern</th></tr>
		?$restrictions
			[$restrictions]
