<span style="font-size: small;font-size: small; float: left; margin-top: 10px; {$font}"> 
	...
	{?( "{$from}" === "{$author}")?}
            {$separatorLinks}<a href="mailto:{$reply_to}?subject=QUITAR {$id}&body=Haga clic en Enviar para enviar este correo y quitar el anuncio seleccionado">Quitar el anuncio</a>
	{/?}
</span>