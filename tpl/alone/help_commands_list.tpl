...
<table cellpadding="5" style="{$font}">
	...
	<tr>
		<td valign="top">
                ...
                Ejemplos:<br/><br/>
                Direcci�n: <br/><a href="mailto:{$reply_to}?subject=MAPA 1600 Amphitheatre Parkway Mountain View CA">MAPA 1600 Amphitheatre Parkway Mountain View CA</a><br/><br/>
				Buscar en las inmediaciones: <br/><a href="mailto:{$reply_to}?subject=MAPA cafeter�a cerca de central park">MAPA cafeter�a cerca de central park</a><br/><br/>
				Lugar: <br/><a href="mailto:{$reply_to}?subject=MAPA Aeropuerto de Madrid">MAPA Aeropuerto de Madrid</a><br/><br/>
				Accidente geogr�fico: <br/><a href="mailto:{$reply_to}?subject=MAPA Monte Everest, Nepal">MAPA Monte Everest, Nepal</a><br/><br/>
		...
		<ul>
			...
			<!--{ <p>Tambi�n puede convertir de una notaci�n a otra. Por ejemplo:</p>
			...
			<li><i>Descriptiva</i>: direcci�n, ciudad, pa&iacute;s o lugar conocido. Por ejemplo: <i>Capitolio, Habana, Cuba</i>. Tambi&eacute;n puedes usar el t&eacute;rmino "cerca" para buscar una categor&iacute;a de lugares 
	...
	<tr style="background:#eeeeee;">
		<td valign="top">
                ...
                <p>Para no recibir notifiación de entrega, puede escribir alguna de las siguientes frases en cualquier parte del asunto: 
