...
{= pf1: Llene todos los campos de su perfil, que funcionara como su tarjeta de presentacion en Apretaste! Tambien nos ayudara a mejorar las busquedas y a personalizar Apretaste! para usted.%0A%0A =}
{= pf2: Su perfil es una combinacion PROPIEDAD = Valor. Asigne un valor para cada PROPIEDAD despues del signo de igual (=) y envie el email. Adjunte una foto de usted si quiere que aparezca como foto del perfil.%0A%0A =} 
