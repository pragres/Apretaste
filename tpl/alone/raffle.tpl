...
{$p}Por cada persona que invites y empiece a usar Apretaste! te ganar&aacute;s un ticket. El <b>(# {$date_to:8,2} #) de {$mes.{$date_to:5,2}} del {$date_to:0,4}</b> pondremos todos los tickets en un 
